      ...
      <div className="dashboard-container">
        ...
        <div className="dashboard-cards">
          ...
          <div className="dashboard-card">
            ...
            <button onClick={()=>navigate('/kalender')} className="dashboard-button">Kalender Uitsig</button>
          </div>
          <div className="dashboard-card">
            <h2>Lêer Oplaai</h2>
            <button onClick={()=>navigate('/leeroplaai')} className="dashboard-button">Lêer Oplaai</button>
          </div>
        </div>
      </div>
    );
